...
import ba.out.bring.odoo.mc1.core.authenticator.SplashActivity
import ba.out.bring.odoo.mc1.core.entities.Many2One
...
import ba.out.bring.odoo.mc1.core.utils.encryptAES
...
fun Context.createOdooUserInAndroidAccount(authenticateResult: AuthenticateResult): Boolean {
    ...
    val account = Account(authenticateResult.androidName, ba.out.bring.odoo.mc1.App.KEY_ACCOUNT_TYPE)
    // https://stackoverflow.com/questions/33270613/android-app-crashes-on-addaccountexplicitlyaccount-password-null
...
fun Context.getOdooUsersFromAccountManager(): List<OdooUser> {
    ...
    manager.getAccountsByType(ba.out.bring.odoo.mc1.App.KEY_ACCOUNT_TYPE)
        .map {
