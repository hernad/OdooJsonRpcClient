...
import ba.out.bring.odoo.mc1.core.utils.JsonElementParceler
...
data class Customer(
    ...
    companion object {
        ...
        val fieldsMap: Map<String, String> = mapOf(
            ...
            "company_name" to "Company Name", "image_512" to "Image", "website" to "Website",
